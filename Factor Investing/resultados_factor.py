...
class MakeReportResult():
    ...
    def __init__(self, df_trades, df_carteiras, nome_arquivo = 'backtest.pdf', caminho_dados = None,
    ...
    def grafico_retorno_movel(self, df, periodo, coluna):
        ...
        plt.savefig(os.path.join(self.caminho_imagens, f'janela_movel_{periodo}_{coluna}.png'), dpi = 300)
...
if __name__ == "__main__":
    ...
    report = MakeReportResult(df_trades=trades, df_carteiras=carteiras, 
                              caminho_imagens=r'C:\Users\vitor\Desktop\Ferramentas Python\Factor Investing\PDFs\Imagens',
                              nome_arquivo=r'C:\Users\vitor\Desktop\Ferramentas Python\Factor Investing\PDFs\backtest.pdf',
