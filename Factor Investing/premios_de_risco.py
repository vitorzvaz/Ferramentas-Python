...
class premio_risco:
    ...
    def __init__(self, indicadores_dict, nome_premio, liquidez=0, caminho_dados = None):
    ...
    def colocando_premio_na_base(self):
        ...
        self.df_premios.to_parquet(os.path.join("..", "BaseDadosBR", "PremiosRiscoBR", f"{self.nome_premio}_{self.liquidez}.parquet"), index = False) 
...
if __name__ == "__main__":
    ...
    premio = premio_risco(indicadores_dict,  liquidez = 5000000, nome_premio = 'ValorDeMercado',
                        caminho_dados = r'C:/Users/vitor/Desktop/Ferramentas Python/BaseDadosBR') #não pode ter \ no nome!!
