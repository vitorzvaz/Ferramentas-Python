...
class PDF(FPDF):
    ...
    def header(self):
        ...
        self.image(os.path.join(r"C:\Users\vitor\Desktop\Ferramentas Python\Modelagem Análise Técnica\PDFs\Imagens", 'logo.png'), 10, 8, 40)
...
class MakePDF():
    ...
    def __init__(self, drawdown_maximo, dia_inicial, dia_final, dias_totais_backtest, 
                 ...
                 otimizacao = False, nome_arquivo = "backtest.pdf", caminho_imagens = None, caminho_pdf = None):
        ...
        shutil.move(f'./{self.nome_arquivo}', f'{self.caminho_pdf}/{self.nome_arquivo}')
    ...
    def grafico_preco_indicadores(self):
        ...
        self.pdf.image(os.path.join(self.caminho_imagens, "grafico_sinais.png"), w = 175, h = 80, x = 20, y = 50)
    ...
    def eventos_estresse(self):
        ...
        self.pdf.image(os.path.join(self.caminho_imagens, 'nave2.png'), x = 130, y = 140, w = 50, h = 50)

    
    def grafico_underwater(self):


        self.pdf.image(os.path.join(self.caminho_imagens, "grafico_underwater.png"), w = 140, h = 60, x = 35, y = 200)
    ...
    def grafico_parametros(self):
        ...
        for i in range(0, (len(self.df_otimizacao))):
            ...
            if i % 2 == 0:
                ...
                self.pdf.image(os.path.join(self.caminho_imagens, f"retorno_por_parametro_{i}.png"), w = 175, h = 80, x = 20, y = 50)

            else:
                
                self.pdf.image(os.path.join(self.caminho_imagens, f"retorno_por_parametro_{i}.png"), w = 175, h = 80, x = 20, y = 150)
