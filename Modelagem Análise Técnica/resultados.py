...
class MakeReportResult():
    ...
    def __init__(self, df_trades, df_dados, nome_arquivo = 'backtest.pdf', 
        ...
        self.caminho_dados = r"C:\Users\vitor\Desktop\Ferramentas Python\BaseDadosBR"
        self.caminho_imagens = r"C:\Users\vitor\Desktop\Ferramentas Python\Modelagem Análise Técnica\PDFs\Imagens"  
        self.caminho_pdf = r"C:\Users\vitor\Desktop\Ferramentas Python\Modelagem Análise Técnica\PDFs"

        self.df_trades = df_trades
        self.df_trades['cota'] = (self.df_trades['retorno'] + 1).cumprod() - 1
        self.dados = df_dados
        self.dados = self.dados.fillna(0)
        self.ibov = pd.read_parquet(os.path.join(self.caminho_dados, 'ibov.parquet'))
        self.cdi = pd.read_parquet(os.path.join(self.caminho_dados, 'cdi.parquet'))
        ...
        if self.otimizacao:
            ...
            if self.parametro1_only:
                ...
                MakePDF(self.drawdown_maximo, self.dia_inicial, self.dia_final, self.dias_totais_backtest, 
                        ...
                        self.maior_sequencia_derrotas, self.joesley_day, self.mar20, self.boasorteday, self.greve_caminhao, 
                        self.crise_2008, self.precatorios, self.df_otimizacao, otimizacao = True, nome_arquivo = self.nome_arquivo,
                        caminho_imagens=self.caminho_imagens, caminho_pdf=self.caminho_pdf
                        )
    ...
    def grafico_retorno_acum(self):
        ...
        plt.savefig(os.path.join(self.caminho_imagens, 'rent_acum.png'), dpi = 300)
    ...
    def grafico_retorno_mes_a_mes(self):
        ...
        plt.savefig(os.path.join(self.caminho_imagens, 'grafico_mes.png'), dpi = 300)
        plt.close()
    ...
    def underwater(self):
        ...
        plt.savefig(os.path.join(self.caminho_imagens, 'grafico_underwater.png'), dpi = 300)
    ...
    def grafico_retorno_ano_a_ano(self):
        ...
        plt.savefig(os.path.join(self.caminho_imagens, 'grafico_ano.png'), dpi = 300)
    ...
    def grafico_preco_indicadores_e_sinais(self):
        ...
        plt.savefig(os.path.join(self.caminho_imagens, 'grafico_sinais.png'), dpi = 300)
    ...
    def grafico_otimizacao(self):
        ...
        for i, df in enumerate(self.lista_df_heatmap_parametros):
            ...
            plt.savefig(os.path.join(self.caminho_imagens, f'retorno_por_parametro_{i}.png'), dpi = 300)
